...
| Card frame | `public/art/frames/<kind>.webp` and `<kind>-sm.webp` | 1103 × 1426 and 552 × 714, WebP with alpha | The designer's frame with the art window knocked out: `character` (blue, 1103 × 1426) and `event` (purple, 987 × 1246, fitted into the 1103 × 1426 box, centred). No nameplate: the name is typeset on the parchment. See `docs/card-template.md`. |
