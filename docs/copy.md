...
- reveal: Move one friendly Gate Character to another Location's open Gate. Its waiting progress is preserved.
...
### Newsboy (`newsboy`)
- cost 1 · Influence 1 · Force 1 · archetype · era: 1905–1960
- reveal: Extra, extra: draw a card.
...
### Barber (`barber`)
- cost 1 · Influence 1 · Force 2 · archetype · era: Any Saturday
...
### Block Captain (`block_captain`)
- cost 1 · Influence 1 · Force 3 · archetype · era: 1960s–
...
- passive: While present, the leading player at her Location loses 1 Influence. At the end of each turn she may relocate to a random Location.
...
### Pullman Porter (`pullman_porter`)
- cost 1 · Influence 2 · Force 2 · archetype · era: 1867–1968
...
### Movement
- Once per turn you may Relocate an Established Character to another Location's Gates. It arrives Fresh and waits again, unless an ability says otherwise.
...
- moves ${charDef(target.defId).name} from ${locName(state, from)} to the Gates of ${locName(state, t.location)}, waiting progress preserved.
...
- ${name(state, c)} relocates from ${locName(state, from)} to the Gates of ${locName(state, r.to)}${c.ready ? ' and is Ready' : ''}.
