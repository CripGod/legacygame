...
- Word spreads. Clearing a Threat is heard at every other open Location, hidden ones included: +1 lasting Influence at each of them. Alone, you take all of it. Together, three points are on the table: the larger Force share takes +1 at every other Location, the smaller +1 at the one other Location where it trails by the most (equal Force: both take +1 everywhere). Everyone who helped gains a Legend. At Legend …, your Characters arrive at the Gates Ready, played or relocated: you have people everywhere.
...
- Word spreads: ${state.players[p].handle} gains +1 lasting Influence at ${locName(state, l.index)} for clearing ${threatName(state, t)}.
