# Black History Card Battler: all copy

Everything a player reads, grouped by where it lives. Keep the `id` lines as they are; edit the text after the colons. Card `text` fields are rules text: keep numbers, keywords in CAPS, and the names of Locations, zones (Gates, Inside), and states (Ready, Fresh, Established, Suppressed, Setback, Legacy) unchanged.

## Characters

### Harriet Tubman (`harriet_tubman`)
- cost 3 · Influence 3 · Force 2 · historical · era: 1822–1913
...
- passive: No curfew holds Harriet herself: she leaves Sundown Town or The Justice System whenever she likes.
...
- cost 6 · Influence 6 · Force 1 · historical · era: 1818–1895
...
- cost 4 · Influence 3 · Force 5 · historical · era: 1800–1859
...
- cost 4 · Influence 4 · Force 2 · historical · era: 1918–2020
...
- cost 4 · Influence 4 · Force 1 · historical · era: 1891–1960
...
- cost 3 · Influence 3 · Force 2 · historical · era: 1858–1927
...
- cost 3 · Influence 3 · Force 3 · historical · era: 1861–1928
...
- cost 2 · Influence 2 · Force 2 · historical · era: 1746–1818
...
- cost 3 · Influence 3 · Force 2 · historical · era: 1839–1915
...
- cost 3 · Influence 3 · Force 1 · historical · era: 1868–1917
...
- cost 2 · Influence 2 · Force 3 · historical · era: 1838–1910
...
### Tom Bass (`tom_bass`)
- cost 3 · Influence 3 · Force 1 · historical · era: 1859–1934
...
### OG (`og`)
- cost 4 · Influence 3 · Force 3 · archetype · era: Timeless
...
- cost 5 · Influence 5 · Force 1 · historical · era: 1862–1931
...
- cost 3 · Influence 2 · Force 3 · historical · era: 1892–1926
- keywords: STRAIGHT_INSIDE
...
- cost 5 · Influence 5 · Force 2 · historical · era: c. 1797–1883
...
- cost 4 · Influence 4 · Force 1 · historical · era: 1892–1960
...
### Ogun (`ogun`)
- cost 5 · Influence 4 · Force 5 · mythic · era: Yoruba
...
- cost 2 · Influence 1 · Force 2 · artist · era: c. 1801–c. 1875
...
- cost 5 · Influence 5 · Force 3 · historical · era: c. 1840–1898
...
- cost 4 · Influence 4 · Force 2 · historical · era: c. 1770–1864
...
- cost 1
- text: Choose a Location: +1 lasting Influence there, and +1 more for each Setback you have suffered this match (max +4 from Setbacks). It counts at the end no matter when you play it. In the Americas: +1 more.
...
- cost 0
- text: Play it while planning: the Ancestors show you your opponent's plan for this turn and every danger the board is about to spring. Choose a Location. In Africa: your Characters there gain +1 Influence this turn.
...
### Comfortable Complicity (`comfortable_complicity`)
...
### Housing Restriction (`housing_restriction`)
...
### The Justice System (`justice_system`)
- era: 1865–
...
- Nothing to play this turn. Lock It In.
- Location ${play.location + 1}
- Play ${name(def.id)}. ${def.text}
- Drag ${name(def.id)} onto ${locLabel}.
...
- His Reveal pays +1 Influence when played into a hidden Location, so blind is exactly where he wants to be.
- It goes straight Inside instead of waiting at the Gates.
- Direct Entry: it may go Inside right away instead of waiting at the Gates.
- Then press Lock It In.
...
- Word spreads. Clearing a Threat is heard at every other open Location, hidden ones included. Everyone who brought Force takes +1 lasting Influence at each of them; whoever brought the most takes +2 (both, on a tie; alone, you brought the most). Everyone who helped gains a Legend. At Legend …, your Characters arrive at the Gates Ready, played or relocated: you have people everywhere.
- A Setback is a loss suffered at the hands of injustice: a Threat or a hostile Location working against you. Your opponent's cards never cause one. Reparations pays +1 lasting Influence on a Location, and +1 more for each Setback (max +4 from Setbacks); it counts at the end no matter when you play it.
...
- ${locNameAt(i)} is Lost: nothing can be played there until the people rebuild it.
...
- Clear your own ${tname} first; then you may Assist against ${view.players[other(me)].handle}'s.
- ${nm} cannot confront ${tname} right now.
- ${nm} is confronting a Threat this turn and cannot move. Tap the Threat to release it.
- ${nm} is already moving this turn. Harriet Tubman can only move a Character that is staying put.
- ${locNameAt(i)} is Lost: nobody can move there until the people rebuild it.
...
- ${nm} cannot enter right now.
- Your Gates at ${locNameAt(i)} are full; a relocated Character arrives at the Gates.
...
- ${cardName(c.defId, placeholders)} confronts
- Summon at L${plan.summon.location + 1}
- Match over: ${view.result?.winner ? 
...
- turn-tracker ${view.phase === 'ended' ? 'disabled' : ''} ${finalTurnLabel(view) ? 'final' : ''}
- Turn ${view.turn} of ${view.maxTurns}. One coin lights per turn.
...
- Played now: +${1 + owed} lasting Influence at the Location you choose${n === 0 ? '' : 
- }, and +1 more in the Americas${americas.length ? 
-  : ''}.${owed < 4 ? ' Every Setback you suffer from here on adds +1 (up to +4).' : ''} It counts at the end no matter when you play it.
...
- s 1x pixel (--u) from the cut
- profile np ${right ? 'right' : ''} p${p} ${view.initiative === p ? 'first' : ''}
...
- np-level ${legend >= LEGEND_READY ? 'spread' : ''}
- Legend ${legend}: word has spread. ${p === me ? 'Your' : 'Their'} Characters arrive at the Gates Ready. ${p === me ? 'You have' : 'They have'} people everywhere.
- Legend ${legend}: Threats ${p === me ? 'you' : 'they'} helped clear. Clearing one pays +1 lasting Influence at every other Location to everyone who brought Force, +2 to whoever brought the most. At ${LEGEND_READY}, Characters arrive at the Gates Ready.
...
Template fields in `${...}` are filled in by the game. Keep them.
...
- ${def.name} come to ${ps.handle}. ${rule.headline}
- Location ${index + 1} is revealed: ${def?.name ?? 'Unknown'}.
- ${name(state, c)} is Ready (${def.name}).
- ${name(state, c)} gains +${c.pendingRevealBonus} Influence as ${def.name} reveals.
- ${def.name}: ${text}
- no Gate Character chosen to move.
- cannot move ${charDef(target.defId).name}: ${held}.
...
- brings ${charDef(t.defId).name} across from ${locName(state, from)} to the Gates, Ready.
- could not bring ${charDef(t.defId).name} across: no room here.
...
- ${def.name}: +${total} lasting Influence at ${locName(state, at)}${why.length ? 
...
- Invalid Relocation.
- A Character cannot enter and relocate in the same turn.
- Invalid confrontation.
