...
Regenerated by `npm run docs` from what is in `public/art`. **7 to go, 105 in.** Send finished files in any zip, named anything; they get resized and filed under the ids below. Full framing rules in `docs/art-spec.md`.
...
- locations (17): accra_ghana, black_star, charleston_1822, gary_indiana, great_migration, greenwood, harpers_ferry, juneteenth, justice_system, lagos, middle_passage, montgomery, oak_bluffs, sundown_town, sundown_town_night, the_stroll, the_tabernacle
