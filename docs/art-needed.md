...
Regenerated by `npm run docs` from what is in `public/art`. **17 to go, 95 in.** Send finished files in any zip, named anything; they get resized and filed under the ids below. Full framing rules in `docs/art-spec.md`.
