...
Regenerated by `npm run docs` from what is in `public/art`. **14 to go, 98 in.** Send finished files in any zip, named anything; they get resized and filed under the ids below. Full framing rules in `docs/art-spec.md`.
...
- locations (12): accra_ghana, black_star, charleston_1822, gary_indiana, great_migration, greenwood, harpers_ferry, juneteenth, justice_system, lagos, middle_passage, sundown_town
