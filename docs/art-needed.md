...
Regenerated by `npm run docs` from what is in `public/art`. **24 to go, 88 in.** Send finished files in any zip, named anything; they get resized and filed under the ids below. Full framing rules in `docs/art-spec.md`.
...
| 4 | `yaa_asantewaa` | Yaa Asantewaa | c. 1840–1921 | Black Star | Queen Mother of Ejisu who shamed the Asante chiefs into war in 1900 and besieged the British garrison in its fort at Kumasi for three months. |
| 5 | `ben_woolfolk` | Ben Woolfolk | Richmond, 1800 | none | A recruiter for Gabriel's rising who turned state's witness and testified against the men he had enlisted. |
| 6 | `pharoah_and_tom` | Pharoah and Tom | Richmond, 1800 | none | Two enslaved men on Mosby Sheppard's place who gave up Gabriel's rising on the day it was to begin. |
| 7 | `cotton_club_orchestra` | The Cotton Club Orchestra | Harlem, 1927–1940 | none | The house band of the Cotton Club: Duke Ellington's orchestra from 1927 to 1931, Cab Calloway's after it. The club's radio wire carried them across the country. |
