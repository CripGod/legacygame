...
Regenerated by `npm run docs` from what is in `public/art`. **10 to go, 102 in.** Send finished files in any zip, named anything; they get resized and filed under the ids below. Full framing rules in `docs/art-spec.md`.
...
- locations (16): accra_ghana, black_star, charleston_1822, gary_indiana, great_migration, greenwood, harpers_ferry, juneteenth, justice_system, lagos, middle_passage, montgomery, oak_bluffs, sundown_town, the_stroll, the_tabernacle
