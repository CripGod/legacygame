...
- **The Tabernacle** protects your Characters from displacement. Establish the church set there (Sister Griffin, Deacon Wells, The Bishop) and **Black Jesus** appears: sanctuary at his Location and +1 Influence to every Character you control. He is never in a deck.
- **The Ancestors** are never in a deck either: hold three Characters Inside at Accra, Ghana and the card comes to your hand once per match. Played while planning, it shows Harborlight's plan for the turn (the AI plans deterministically, so peeking changes nothing) and every timed danger on the board.
