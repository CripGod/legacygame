...
- **Energy**: every card has a cost (0 to 7). Each turn a player gets Energy equal to the turn number, plus +1 per Established Hubert Harrison or Denmark Vesey, plus +1 the turn after holding two Inside at Oak Bluffs; unspent Energy is lost. Cheap cards early, the big names later. Gate capacity (two per Location) is the other limit on how much you can drop at once.
...
- **Every card is somebody, or something, that existed.** The invented archetypes are gone: the Newsboy is John Russwurm (Freedom's Journal, 1827), the Barber is Alonzo Herndon, the Block Captain is Callie House, the Neighbor Kid is Bud Billiken (the Chicago Defender's 1923 mascot), Karen is Roger Taney, the Pullman Porter is the Sleeping Car Porters (the 1925 Brotherhood), the Organizer is Hubert Harrison, the OG is Clara Brown, the Cookout is the Bud Billiken Parade (1929) and Chairteenth is the Fisk Jubilee Singers (1871). Brand characters and institutions count as long as they are real history. Threats and Events are conditions, not people, and keep their names.
...
- **The Ancestors** are never in a deck either: in 25% of matches (rolled at setup), holding three Characters Inside at Accra, Ghana brings the card to your hand once. The Fisk Jubilee Singers have the same 25% roll and arrives when Montgomery, Alabama reveals. Played while planning, it shows Harborlight's plan for the turn (the AI plans deterministically, so peeking changes nothing) and every timed danger on the board.
...
- **Events** are played into the purple Event slot beside your Gates at a Location: one per Location per player per turn, and the Gates can be full. Each works everywhere and gets a bonus from where it lands: Reparations +1 in the Americas, The Ancestors +1 Influence in Africa, Word of Mouth draws 2 with a crowd, Community Defense +2 Force at its Location, Persuade drains all opposing Gate Characters and turns the weakest at its Location. Decks carry at most two.
- **Gatherings** are Characters that are never in a deck. **The Bud Billiken Parade** (2/1) arrives at Great Migration, Inside if there is room, once you have three Established Characters there, and only in about half of matches (rolled when the match is created); its other Established friends get +1 Influence and your arrivals there are Ready at once. **The Fisk Jubilee Singers** (1/3, +1 Force to friendly confronters) arrives Ready at both players' Gates the moment Juneteenth is revealed. Each arrival opens a fanfare card. If a card ever returns a Gathering to hand, it can be replayed like any Character.
