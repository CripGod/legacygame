...
- **"History moves"**: at the start of Turn 3 one random Threat (Patrol, Complicity, Housing Restriction or the DeWolf Trade) appears at a revealed Location without one, and on Turn 5 a second one arrives in about 60% of matches. Greenwood spawns a Mob on Turn 4. Harpers Ferry reveals with Paddy Rollers.
