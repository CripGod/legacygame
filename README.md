...
- **The Ancestors** are never in a deck either: in 25% of matches (rolled at setup), holding three Characters Inside at Accra, Ghana brings the card to your hand once. Chairteenth has the same 25% roll. Played while planning, it shows Harborlight's plan for the turn (the AI plans deterministically, so peeking changes nothing) and every timed danger on the board.
