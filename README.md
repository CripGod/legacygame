...
- **Energy**: every card has a cost (0 to 7). Each turn a player gets Energy equal to the turn number up to a cap of 7 (`ENERGY_CAP`: Turns 7 to 10 all pay 7, so the last stretch is decided by the hand, not by a flood of Energy), plus +1 per Established Organizer or Denmark Vesey, plus +1 the turn after holding two Inside at Oak Bluffs; unspent Energy is lost. Cheap cards early, the big names later. Gate capacity (two per Location) is the other limit on how much you can drop at once.
...
A round robin of the four preset decks at build 129 (30 AI matches per pairing, 180 in all): Black Star 57%, Bois Caïman 52%, Railroad 42%, Pantheon 38%. Caïman came up from 31% with Boukman at 8 (Influence 5), Fatiman's Rebellion discount at 2, and Shango, Madam Walker, Oshun, Robert Smalls and Tanner in the deck; Railroad and Pantheon are the next tuning targets (Mansa Musa at 6 and Shango at 4 cost them tempo). Lead changes run 6 to 8 a match, final-turn flips 0.5 to 0.8. With Harborlight's stand thresholds at 0.84 / 0.94 (bluff 2%, never before Turn 5) about 80% of AI matches reach The Last Word on a single stand; in PvP that is a human call.
