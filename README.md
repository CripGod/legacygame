...
- **Artists.** A new category: Edmonia Lewis, Henry Ossawa Tanner, Robert Duncanson, Edward Bannister, Harriet Powers and David Drake (Dave the Potter). Their work outlasts them: an artist's Reveal (or Tanner's standing ability, every turn) adds *lasting Influence to the Location itself* for that player, which stays when the artist leaves or is knocked away. Lewis +2, Drake +1, Bannister +1 (+1 more in the Americas), Powers +1 per other friendly Character there (max 3), Duncanson +1 at every Location where you are Established.
