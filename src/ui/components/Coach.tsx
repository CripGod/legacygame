...
const TIPS: { key: string; text: string; when: (v: GameState, me: PlayerId, plan: TurnPlan) => boolean }[] = [
  ...
  { key: 'final', text: 'Last turn unless someone stands. After it the Locations are counted: win two of three. Commit everything that can enter; Reveals resolve before entries.', when: (v) => v.turn >= v.maxTurns },
