...
export const HINTS = {
  ...
  energy: 'Energy: what you can spend on cards this turn. It equals the turn number (Turn 3 = 3 Energy), Organizer adds +1, and unspent Energy does not carry over.',
  cost: 'Cost: the Energy this card takes to play. Energy equals the turn number, so expensive cards wait for later turns.',
  stakes: 'Stakes: what the match is worth. Stand on Business doubles it (1 → 2 → 4) one turn later, extends the match to 10 turns, and means you cannot Step Off. The other side gets one turn to Step Off at the old price.',
  stakesPending: 'Someone Stood on Business. The raise lands after this turn: Step Off now to lose only the current Stakes.',
