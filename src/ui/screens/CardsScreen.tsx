  ...
  return (
    <section id="cx-reading" className="cx-chapter">
      ...
      <Page className="cx-reading">
        ...
        <p className="cx-frames-lede">
          Nine more frames sit outside the ladder. A finish is worn in place of the rank's frame; the rank goes on climbing underneath, and a finish says nothing about it. They will be the store's, bought with Legacy or won; for now a few cards in every deck wear them so you can see each one in play. Stars and Stripes is worn by American political figures only, and Camouflage by soldiers, rebels and the war-involved.
        </p>
