    ...
    <div className="screen" style={{ placeItems: 'start center' }}>
      <div className="inner rules">
        ...
        <ul>
          ...
          <li><b>The Middle Passage</b> has no Inside: everyone at its Gates loses 1 Influence for good each turn, and whoever leaves arrives Ready and carries +1 Influence for good. <b>The DeWolf Trade</b> (a Threat, 5 Force) ships the lowest Waiting Gate Character at its Location there, or to a random Location, with a Setback.</li>
