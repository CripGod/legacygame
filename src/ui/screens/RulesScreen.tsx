  ...
  return (
    <div className="screen" style={{ placeItems: 'start center' }}>
      <div className="inner rules">
        ...
        <h2>The match</h2>
        <ul>
          <li>Two players, three Locations, seven turns (an 8th if someone Stands on Business), 18-card decks. Four-card opening hand and one draw every turn. Hands hold at most seven cards: a draw into a full hand is discarded.</li>
        ...
        <h2>Threats</h2>
        <ul>
          <li>Threats are neutral dangers generated by Locations and by history moving on Turn 3 (and, most matches, again on Turn 5). Tap a Threat to commit Characters' Force against it.</li>
