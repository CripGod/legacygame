    ...
    <div className="screen" style={{ placeItems: 'start center' }}>
      <div className="inner rules">
        ...
        <ul>
          ...
          <li><b>Word spreads.</b> Clearing a Threat is heard at every other open Location: +1 lasting Influence at each of them. Alone, you take all of it; together, it splits by Force contributed (rounded down, the remainder to the larger share; equal shares split evenly). Everyone who helped gains a <b>Legend</b>. At Legend {LEGEND_READY}, your Characters arrive at the Gates Ready, played or relocated: you have people everywhere.</li>
