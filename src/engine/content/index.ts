...
export const PRESET_DECKS: Record<string, { name: string; style: string; cards: string[] }> = {
  ...
  caiman: {
    name: 'Bois Caïman',
    style: 'The cost flow. Fatiman, Booker T. and Carver bring prices down, Rebellion Characters make Boukman (8) cheaper still, and his Uprising sends every Ready Character Inside at once.',
    cards: [
      'boukman_dutty',
      'cecile_fatiman',
      'booker_t_washington',
