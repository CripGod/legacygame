...
export const HOMES: Record<string, HomeGround> = {
  ...
  zora_neale_hurston: { locations: ['great_migration', 'harlem_renaissance'], why: 'Eatonville to Harlem in the Migration years, an Opportunity prize in 1925, then back South to collect the folklore.' },
  ...
  cotton_club_orchestra: { locations: ['cotton_club', 'harlem_renaissance'], why: "The house band, 1927 to 1940: Ellington's orchestra, then Calloway's. The radio wire from that bandstand made them famous." },
  ...
  taytu_betul: { locations: ['accra_ghana'], why: 'Ethiopia is not on the board. Adwa was hers as much as his, and Accra is where its heirs raised the flag.', thematic: true },
