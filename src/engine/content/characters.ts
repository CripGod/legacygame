...
const GATHERINGS: CharacterDef[] = [
  ...
  },
  {
    ...
    short: 'Bannister',
    summary: 'This Location gains +1 Influence for you for good, +2 in the Americas.',
    influence: 2,
    force: 1,
    tags: ['Black', 'Artist', 'Painter'],
    keywords: [],
    reveal: {
      text: 'Under the Oaks: this Location gains +1 lasting Influence for you, +1 more if it is in the Americas.',
      effect: { type: 'monument', amount: 1, americasBonus: 1 },
    },
