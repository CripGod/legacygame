...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    short: 'Zora',
    summary: 'Draw a card. Your Gate Characters here get +1 Influence.',
    influence: 3,
    force: 1,
  ...
  },
  {
    ...
    name: 'Daniel Payne',
    short: 'Payne',
    summary: 'Draw a card. +1 Influence with a friend at this Location.',
    influence: 1,
    force: 1,
  ...
  },
  {
    ...
    name: 'Denmark Vesey',
    short: 'Vesey',
    summary: 'Challenges their best Gate Character. Established: +1 Energy.',
    influence: 3,
    force: 4,
  ...
  },
  {
    ...
    short: 'Walker',
    summary: 'Draw a card. Your next Established here gets +1 Influence.',
    influence: 4,
    force: 1,
    tags: ['Black', 'Business'],
    keywords: [],
  ...
  },
  {
    ...
    identity: ['mobilization', 'street corner', 'tempo'],
    era: '1883–1927',
    blurb: 'The father of Harlem radicalism: a soapbox orator on Lenox Avenue who taught a generation how to organize.',
    history:
      'Born in St. Croix in 1883, Hubert Henry Harrison came to New York at seventeen and became the most brilliant street speaker in Harlem, lecturing on socialism, race and science from a stepladder on Lenox Avenue. He founded the Liberty League and The Voice in 1917, the first organization and newspaper of the New Negro movement, and edited Marcus Garvey\'s Negro World before breaking with him. He died after an appendectomy in 1927, aged forty-four.',
  },
  {
    kind: 'character',
    id: 'clara_brown',
    ...
    identity: ['respect', 'territory', 'the first door'],
    era: '1800–1885',
...
const MYTHIC: CharacterDef[] = [
  ...
  },
  {
    ...
    name: 'Oshun',
    short: 'Oshun',
    summary: 'A friend here gets +1 Influence, permanently.',
    influence: 4,
    force: 1,
...
const GATHERINGS: CharacterDef[] = [
  ...
  },
  {
    ...
    influence: 1,
    force: 3,
    tags: ['Gathering', 'Music', 'Solidarity'],
    keywords: [],
    established: {
      text: 'Your Characters here confront Threats with +1 Force.',
      effect: { type: 'forceAuraHere', amount: 1 },
...
CHARACTERS.push(
  ...
  },
  {
    ...
    name: 'Marie Laveau',
    short: 'Laveau',
    summary: 'Their best Gate Character here crosses over to your side.',
    influence: 3,
    force: 2,
