...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    history:
      'Elizabeth Freeman, called Mum Bett, was born enslaved around 1744 in Claverack, New York, and was held for decades by Colonel John Ashley of Sheffield, Massachusetts. In 1781, after the new state constitution declared that all men are born free and equal, she asked the lawyer Theodore Sedgwick to test it in court. Brom and Bett v. Ashley went to a jury in Great Barrington on 21 August 1781; the jury found that she and the enslaved man Brom were free and awarded thirty shillings in damages. With the Quock Walker cases of 1781 to 1783, the verdict helped end slavery in Massachusetts. She took the name Elizabeth Freeman, worked for wages in the Sedgwick household as housekeeper and nurse to the children, served the town as midwife and healer, bought her own house and land in Stockbridge, and died there on 28 December 1829. She is buried in the Sedgwick family plot, the only person there who was not a Sedgwick. Catharine Sedgwick remembered her saying she would take one minute of freedom even if she died at the end of it.',
  },
  {
    kind: 'character',
    id: 'cathay_williams',
    ...
    history:
      'Cathay Williams was born enslaved around 1844 near Independence, Missouri. When Union troops took Jefferson City in 1861 she was taken along as a cook and laundress and travelled with the army through the war. On 15 November 1866 she enlisted in St. Louis as William Cathay (the papers spell it Cathey), a private in Company A of the 38th United States Infantry, one of the new Black regular regiments that history remembers as the Buffalo Soldiers, and went with it to Kansas and New Mexico Territory, where the regiment guarded the Santa Fe Trail and garrisoned the forts along it. Hospitalized repeatedly, she was discharged on a surgeon\'s certificate of disability at Fort Bayard on 14 October 1868. She told her story to the St. Louis Daily Times, which printed it on 2 January 1876. Her application for a disability pension in 1891 was rejected in February 1892; no record of her survives after that, and she is conventionally said to have died around 1893 in Trinidad, Colorado.',
  },
  {
    kind: 'character',
    id: 'james_lafayette',
