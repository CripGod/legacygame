...
const brit = (title: string, slug: string, kind: 'biography' | 'topic' | 'event' | 'place' = 'biography', note?: string): Reference => ({ title, url: `https://www.britannica.com/${kind}/${slug}`, by: 'Encyclopaedia Britannica', note });
...
export const MORE_REFERENCES: Record<string, Reference[]> = {
  // ---- Characters
  harriet_tubman: [brit('Harriet Tubman', 'Harriet-Tubman'), src('Harriet Tubman Underground Railroad National Historical Park', 'https://www.nps.gov/hatu/index.htm', 'National Park Service')],
  frederick_douglass: [brit('Frederick Douglass', 'Frederick-Douglass'), src('Frederick Douglass Papers', 'https://www.loc.gov/collections/frederick-douglass-papers/', 'Library of Congress'), src('Frederick Douglass National Historic Site', 'https://www.nps.gov/frdo/index.htm', 'National Park Service')],
  john_brown: [brit('John Brown', 'John-Brown-American-abolitionist'), src('Harpers Ferry National Historical Park', 'https://www.nps.gov/hafe/index.htm', 'National Park Service')],
  sojourner_truth: [brit('Sojourner Truth', 'Sojourner-Truth')],
  ida_b_wells: [brit('Ida B. Wells-Barnett', 'Ida-B-Wells-Barnett')],
  booker_t_washington: [brit('Booker T. Washington', 'Booker-T-Washington'), src('Booker T. Washington National Monument', 'https://www.nps.gov/bowa/index.htm', 'National Park Service'), src('Tuskegee Institute National Historic Site', 'https://www.nps.gov/tuin/index.htm', 'National Park Service')],
  george_washington_carver: [brit('George Washington Carver', 'George-Washington-Carver'), src('George Washington Carver National Monument', 'https://www.nps.gov/gwca/index.htm', 'National Park Service')],
  ...
  madam_cj_walker: [brit("Madam C.J. Walker", 'Madam-C-J-Walker')],
  ...
  roger_taney: [brit('Roger B. Taney', 'Roger-B-Taney')],
  richard_allen: [brit('Richard Allen', 'Richard-Allen-American-clergyman')],
  absalom_jones: [brit('Absalom Jones', 'Absalom-Jones')],
  daniel_payne: [brit('Daniel Alexander Payne', 'Daniel-Alexander-Payne')],
  henry_mcneal_turner: [brit('Henry McNeal Turner', 'Henry-McNeal-Turner')],
  ...
  edward_bannister: [brit('Edward Mitchell Bannister', 'Edward-Mitchell-Bannister')],
  ...
  menelik_ii: [brit('Menelik II', 'Menelik-II'), brit('Battle of Adwa', 'Battle-of-Adwa', 'event')],
  taytu_betul: [brit('Battle of Adwa', 'Battle-of-Adwa', 'event')],
  yaa_asantewaa: [brit('Yaa Asantewaa', 'Yaa-Asantewaa')],
  mansa_musa: [brit('Mūsā I of Mali', 'Musa-I-of-Mali')],
  paul_laurence_dunbar: [brit('Paul Laurence Dunbar', 'Paul-Laurence-Dunbar'), src('Paul Laurence Dunbar House', 'https://www.nps.gov/daav/learn/historyculture/dunbar-house.htm', 'National Park Service')],
  ...
  elizabeth_freeman: [brit('Elizabeth Freeman', 'Elizabeth-Freeman')],
  mary_ellen_pleasant: [brit('Mary Ellen Pleasant', 'Mary-Ellen-Pleasant')],
  cotton_club_orchestra: [brit('Duke Ellington', 'Duke-Ellington'), brit('Cotton Club', 'Cotton-Club', 'topic')],
  samuel_ajayi_crowther: [brit('Samuel Ajayi Crowther', 'Samuel-Ajayi-Crowther')],
  marie_laveau: [brit('Marie Laveau', 'Marie-Laveau')],
  omar_ibn_said: [brit('Omar ibn Said', 'Omar-ibn-Said'), src('Omar Ibn Said Collection', 'https://www.loc.gov/collections/omar-ibn-said-collection/', 'Library of Congress')],
  cathay_williams: [brit('Cathay Williams', 'Cathay-Williams')],
  william_still: [brit('William Still', 'William-Still')],
  david_ruggles: [brit('David Ruggles', 'David-Ruggles')],
  lewis_hayden: [brit('Lewis Hayden', 'Lewis-Hayden')],
  james_lafayette: [brit('James Armistead Lafayette', 'James-Armistead')],
  john_russwurm: [brit('John Brown Russwurm', 'John-Brown-Russwurm')],
  zumbi_dos_palmares: [brit('Zumbi', 'Zumbi')],
  anansi: [brit('Anansi', 'Anansi', 'topic')],
  shango: [brit('Shango', 'Shango', 'topic')],
  ogun: [brit('Ogun', 'Ogun', 'topic')],
  oshun: [brit('Oshun', 'Oshun', 'topic')],
  mami_wata: [brit('Mami Wata', 'Mami-Wata', 'topic')],
  // ---- Locations
  greenwood: [brit('Tulsa race massacre of 1921', 'Tulsa-race-massacre-of-1921', 'event'), src('1921 Tulsa Race Massacre', 'https://www.tulsahistory.org/exhibit/1921-tulsa-race-massacre/', 'Tulsa Historical Society and Museum')],
  harpers_ferry: [brit("John Brown's Raid on Harpers Ferry", 'Harpers-Ferry-Raid', 'event'), src('Harpers Ferry National Historical Park', 'https://www.nps.gov/hafe/index.htm', 'National Park Service')],
  ...
  middle_passage: [brit('Middle Passage', 'Middle-Passage-slave-trade', 'topic')],
  ...
  reparations: [brit('Reparations', 'reparations-history', 'topic')],
};
