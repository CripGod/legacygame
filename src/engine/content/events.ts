...
export const EVENTS: EventDef[] = [
  {
    ...
    name: 'Reparations',
    short: 'Reparations',
    summary: '+1 lasting Influence here per Setback (max 4), +1 in the Americas. Counts at the end.',
    cost: 1,
  ...
  },
  {
    ...
    short: 'Defense',
    summary: 'Nothing of yours can be blocked or displaced this turn. +2 Force here.',
    cost: 2,
  ...
  },
  {
    ...
    name: 'The Ancestors',
    short: 'Ancestors',
    summary: "See Harborlight's plan and every coming danger.",
    cost: 0,
  ...
  },
  {
    ...
    name: 'Word of Mouth',
    short: 'Word',
    summary: 'Draw a card; draw 2 where you have 2+ Characters.',
    cost: 0,
